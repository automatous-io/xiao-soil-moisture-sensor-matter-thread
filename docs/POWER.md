...
|---|---|---|---|---|---|
| 1 | ICD Standard Mode | v0.2.0, then v0.4.0 over OTA | 900 s / +10 dBm | Aug 5, 2026 | Three days on alkaline, ten days on USB-C from a 50,000 mAh power bank, then lithium from Aug 18. That lithium cell died on Sep 8 after 21 days. On a fresh lithium cell since Sep 13 |
| 2 | LIT Battery Saver Mode | v0.2.0, then v0.4.0 over OTA | 900 s / +10 dBm | Aug 5, 2026 | Alkaline from Aug 5 to Aug 18, pulled at 53%, then lithium from Aug 18. Still running on that cell at 28 days as of Sep 14, at 1.51 V and a reported 100% |
